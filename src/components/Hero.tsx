      ...
      <div className="relative z-20 flex flex-1 flex-col">
        ...
        >
          ...
          >
            ...
            >
              Tu socio de<span className="sm:hidden"> </span>
              <br className="hidden sm:block" />
              crecimiento digital<span className="sm:hidden"> </span>
              <br className="hidden sm:block" />
              para pymes que van en serio.
            </span>
          </motion.h1>
          ...
          >
            Analizamos tu operación, tus campañas y tu presencia digital para
            diseñar una estrategia clara — y ejecutarla con vos, paso a paso.
          </motion.p>
  ...
  return (
    <div className="inline-flex items-center gap-2.5 self-start rounded-[4px] bg-white px-3 py-2 shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-shadow duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
      <svg
        ...
        viewBox="0 0 100 100"
        className="h-5 w-5 fill-current text-[#153B2E] sm:h-6 sm:w-6"
        aria-hidden="true"
      >
      ...
      <span className="rounded bg-[#153B2E] px-1.5 py-0.5 text-[10px] text-white sm:px-2 sm:text-[11px]">
        Certificado
      </span>
    </div>
  )
